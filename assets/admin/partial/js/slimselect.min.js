!(function (e, t) {
    ...
    class i {
        constructor(t) {
            (this.id = ""),
                ...
                (this.hideSelected =
                    void 0 !== t.hideSelected && t.hideSelected),
                ...
                this.data.forEach((i) => {
                    if (i instanceof n) {
                        ...
                        if (
                            (i.options.forEach((i) => {
                                (e && !e(i)) ||
                                    (t ? l.push(new a(i)) : s.push(new a(i)));
                            }),
                            l.length > 0)
                        ) {
                            let e = new n(i);
        ...
        open() {
            ...
            if (e.length) {
                const t = e[e.length - 1].id,
                    s = this.content.list.querySelector(
                        '[data-id="' + t + '"]'
                    );
                    ...
                    (i.onclick = (e) => {
                        ...
                        const s = (e) => {
                                ...
                                if (
                                    ...
                                    this.callbacks.setSelected([t.value], !0);
            ...
            for (const t of e) {
                if (t instanceof n) {
                    ...
                    if (
                        ...
                        o.setAttribute(
                            "d",
                            this.classes.optgroupSelectAllCheck
                        ),
                            a.appendChild(o),
        ...
        option(e) {
            ...
            return (
                ...
                t.addEventListener("click", (t) => {
                    ...
                    if (
                        e.disabled ||
                        (e.selected && !this.settings.allowDeselect)
                    )
                        return;
                    if (
                        (this.settings.isMultiple &&
    ...
    class c {
        ...
        getData() {
            ...
            for (const s of t)
                "OPTGROUP" === s.nodeName &&
                    e.push(this.getDataFromOptgroup(s)),
                    "OPTION" === s.nodeName &&
                        e.push(this.getDataFromOption(s));
            return e;
        }
        ...
        updateOptions(e) {
            ...
            for (const t of e)
                t instanceof n &&
                    this.select.appendChild(this.createOptgroup(t)),
                    t instanceof a &&
                        this.select.appendChild(this.createOption(t));
                ...
                ? t
                      .then((e) => {
                          this.render.renderOptions(
                              this.store.partialToFullData(e)
                          );
                      })
                      .catch((e) => {
